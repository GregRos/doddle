...
export type Get_Value_At_Path<T, Path extends PropertyKey[]> = Path extends [keyof T]
    ? T[Path[0]]
...
export type Split_Dotted_Path<Path extends string> = Path extends `${infer Head}.${infer Rest}`
