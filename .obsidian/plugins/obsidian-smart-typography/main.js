...
const emDash = {
    ...
    matchRegExp: /–-$/,
    performUpdate: (instance, delta, settings) => {
        delta.update({ line: delta.from.line, ch: delta.from.ch - 1 }, delta.to, [emDashChar])
    },
    performRevert: (instance, delta, settings) => {
...
const pairedDoubleQuote = {
    ...
    matchRegExp: /""$/,
    performUpdate: (instance, delta, settings) => {
        delta.update(delta.from, delta.to, [settings.openDouble + settings.closeDouble])
    },
    performRevert: (instance, delta, settings) => {
        if (instance.getRange(delta.from, delta.to) === settings.openDouble) {
            delta.update(
                delta.from,
                Object.assign(Object.assign({}, delta.to), { ch: delta.to.ch + 1 }),
                ['""']
            )
            setTimeout(() =>
                instance.setCursor(
                    Object.assign(Object.assign({}, delta.from), { ch: delta.from.ch + 1 })
                )
            )
        }
    }
...
const pairedSingleQuote = {
    ...
    matchRegExp: /''$/,
    performUpdate: (instance, delta, settings) => {
        delta.update(delta.from, delta.to, [settings.openSingle + settings.closeSingle])
    },
    performRevert: (instance, delta, settings) => {
        if (instance.getRange(delta.from, delta.to) === settings.openSingle) {
            delta.update(
...
const legacyComparisonRules = [lessThanOrEqualTo, greaterThanOrEqualTo, notEqualTo]
            ...
            this.registerEditorExtension([
                ...
                state.EditorState.transactionFilter.of(tr => {
                    ...
                    const canPerformReplacement = pos => {
                        ...
                        if (!tree) tree = language.syntaxTree(tr.state)
                    ...
                    tr.changes.iterChanges((fromA, toA, fromB, toB, inserted) => {
                        ...
                        for (let rule of matchedRules) {
                            ...
                            newSelection = state.EditorSelection.create(
...
class SmartTypographySettingTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(toggle => {
                toggle.setValue(this.plugin.settings.curlyQuotes).onChange(value =>
        ...
        new obsidian.Setting(containerEl).setName("Open double quote character").addText(text => {
            text.setValue(this.plugin.settings.openDouble).onChange(value =>
                __awaiter(this, void 0, void 0, function* () {
                    if (!value) return
                    if (value.length > 1) {
        ...
        new obsidian.Setting(containerEl).setName("Close double quote character").addText(text => {
            text.setValue(this.plugin.settings.closeDouble).onChange(value =>
                __awaiter(this, void 0, void 0, function* () {
                    if (!value) return
                    if (value.length > 1) {
                        text.setValue(value[0])
        ...
        new obsidian.Setting(containerEl).setName("Open single quote character").addText(text => {
            text.setValue(this.plugin.settings.openSingle).onChange(value =>
                __awaiter(this, void 0, void 0, function* () {
                    if (!value) return
                    if (value.length > 1) {
                        text.setValue(value[0])
        ...
        new obsidian.Setting(containerEl).setName("Close single quote character").addText(text => {
            text.setValue(this.plugin.settings.closeSingle).onChange(value =>
                __awaiter(this, void 0, void 0, function* () {
                    if (!value) return
                    if (value.length > 1) {
                        text.setValue(value[0])
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(toggle => {
                toggle.setValue(this.plugin.settings.emDash).onChange(value =>
                    __awaiter(this, void 0, void 0, function* () {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(toggle => {
                toggle.setValue(this.plugin.settings.skipEnDash).onChange(value =>
                    __awaiter(this, void 0, void 0, function* () {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(toggle => {
                toggle.setValue(this.plugin.settings.ellipsis).onChange(value =>
                    __awaiter(this, void 0, void 0, function* () {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(toggle => {
                toggle.setValue(this.plugin.settings.guillemets).onChange(value =>
                    __awaiter(this, void 0, void 0, function* () {
        ...
        new obsidian.Setting(containerEl).setName("Open guillemet").addText(text => {
            text.setValue(this.plugin.settings.openGuillemet).onChange(value =>
                __awaiter(this, void 0, void 0, function* () {
                    if (!value) return
        ...
        new obsidian.Setting(containerEl).setName("Close guillemet").addText(text => {
            text.setValue(this.plugin.settings.closeGuillemet).onChange(value =>
                __awaiter(this, void 0, void 0, function* () {
                    if (!value) return
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc("<- | -> will be converted to ← | →")
            .addToggle(toggle => {
                toggle.setValue(this.plugin.settings.arrows).onChange(value =>
                    __awaiter(this, void 0, void 0, function* () {
        ...
        new obsidian.Setting(containerEl).setName("Left arrow character").addText(text => {
            text.setValue(this.plugin.settings.leftArrow).onChange(value =>
                __awaiter(this, void 0, void 0, function* () {
                    if (!value) return
                    if (value.length > 1) {
                        text.setValue(value[0])
        ...
        new obsidian.Setting(containerEl).setName("Right arrow character").addText(text => {
            text.setValue(this.plugin.settings.rightArrow).onChange(value =>
                __awaiter(this, void 0, void 0, function* () {
                    if (!value) return
                    if (value.length > 1) {
                        text.setValue(value[0])
        ...
        new obsidian.Setting(containerEl)
            ...
            .setDesc("<= | >= | /= will be converted to ≤ | ≥ | ≠")
            .addToggle(toggle => {
                toggle.setValue(this.plugin.settings.comparisons).onChange(value =>
                    __awaiter(this, void 0, void 0, function* () {
        ...
        new obsidian.Setting(containerEl)
            ...
            .addToggle(toggle => {
                toggle.setValue(this.plugin.settings.fractions).onChange(value =>
                    __awaiter(this, void 0, void 0, function* () {
